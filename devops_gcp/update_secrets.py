...
from devops_gcp.common import run_command_print
...
def update_kubernetes_secrets():
    ...
    updates = [
        ('secret-trading-binance-env-vars', './k8s/secrets/envvar.env'),
        ('secret-trading-binance-trading-param-json', './k8s/secrets/tradingparam.json'),
        ]
