...
docker build -t market-realtime-move-report-kinesis . -f devops/Dockerfile --platform linux/x86_64
docker tag market-realtime-trading-kinesis:latest ${ECR_REPOSITORY_URI}:latest
