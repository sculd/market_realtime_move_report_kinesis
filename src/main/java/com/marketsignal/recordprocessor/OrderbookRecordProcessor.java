 ...
 */
public class OrderbookRecordProcessor implements ShardRecordProcessor {

    private static final String SHARD_ID_MDC_KEY = "ShardId";

    private static final Logger log = LoggerFactory.getLogger(OrderbookRecordProcessor.class);
    ...
    OrderbookStream orderbookStream = new OrderbookStream(Duration.ofMinutes(10), Duration.ofSeconds(1), Duration.ofSeconds(30));
