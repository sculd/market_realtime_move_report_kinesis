        ...
        switch (positionSideType) {
            ...
            case SHORT:
                ...
                try {
                    ...
                    logger.error("{} binance error checking out binance margin account: {}", symbol, ex.toString());
                    return failResult;
                }
                ...
                if (borrowQuantity <= 0) {
                    ...
                    try {
                        ...
                        logger.error("{} binance error borrowing: {}", symbol, ex.toString());
                        return failResult;
                    }
                ...
                try {
                    ...
                    logger.error("{} binance error checking margin account: {}", symbol, ex.toString());
                    return failResult;
                }
