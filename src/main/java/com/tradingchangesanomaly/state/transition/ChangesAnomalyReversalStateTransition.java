...
public class ChangesAnomalyReversalStateTransition extends ChangesAnomalyStateTransition {
    ...
    public ChangesAnomalyReversalStateTransition(String market, String symbol, OrderbookFactory orderbookFactory, MarginAsset marginAsset, TransitionInitParameter initParameter) {
